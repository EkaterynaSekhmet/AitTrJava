...
Массивы (Array)
ArrayList - расширяемый список
HashSet - множество уникальных элементов
HashMap - пара ключ + значение
методы (модификаторы доступа, тип возвращаемых данных или void, наименование, передаваемые на вход параметры)
числовые системы
...
полиморфизм - это когда методы в классах могут иметь одинаковые НАЗВАНИЕ (смысл) и мы можем их переопределять в дочерних классах
